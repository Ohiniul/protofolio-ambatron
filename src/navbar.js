        ...
        <nav className="bg-customLightGreen p-4 fixed top-0 left-0 w-full z-50">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="text-4xl font-bold flex items-center">
                    <span className="text-purple-600">Amba</span>
                    <span className="text-customGreen">tron.</span>
                </div>
                ...
                <ul className="hidden lg:flex space-x-6 text-lg">
                    <li className="relative">
                        ...
                        <button
                            ...
                            className="text-black hover:text-blue-800 transition duration-300 focus:outline-none font-bold"
                        >
                            Home
                        </button>
                        {isDropdownOpen && (
